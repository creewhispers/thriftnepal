      ...
      <div className="grid lg:grid-cols-12 gap-6 lg:gap-8 items-stretch">
        <div className="lg:col-span-7 flex flex-col justify-between rounded-3xl bg-secondary/60 p-6 md:p-10 lg:p-14 min-h-[60vh]">
          <div className="flex items-center gap-2 text-xs uppercase tracking-[0.18em] text-muted-foreground">
            ...
            Nepal's thrift marketplace · est. 2026
          </div>
          ...
          <div className="mt-10">
            ...
            <p className="mt-6 max-w-md text-base md:text-lg text-muted-foreground">
              ...
              fashion — built for Nepal's next generation.
            </p>

            <div className="mt-8 flex flex-wrap gap-3">
              <button className="group inline-flex items-center gap-2 rounded-full bg-foreground text-background px-6 py-3 text-sm font-medium hover:opacity-90 transition">
                Start Selling
                <ArrowUpRight className="h-4 w-4 transition group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
              </button>
              <button className="inline-flex items-center gap-2 rounded-full border border-border bg-card/60 px-6 py-3 text-sm font-medium hover:bg-secondary transition">
                Explore Items
              </button>
            </div>
          </div>
          ...
          <div className="mt-10 flex flex-wrap gap-x-8 gap-y-3 text-xs text-muted-foreground">
            <Stat n="12k+" l="active listings" />
            <Stat n="3.4k" l="verified sellers" />
            <Stat n="77" l="cities in Nepal" />
            <Stat n="4.9" l="avg seller rating" />
          </div>
        </div>
        ...
        <div className="lg:col-span-5 relative rounded-3xl overflow-hidden bg-muted min-h-[60vh]">
          ...
          <div className="absolute bottom-5 left-5 right-5 text-white">
            ...
            <p className="text-xs opacity-80 mt-1">curated by @prerana.fits · Kathmandu</p>
          </div>
        </div>
      </div>
    </section>
